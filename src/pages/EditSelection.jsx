        ...
        <div className="h-max flex flex-col w-full items-center justify-center bg-slate-900 py-[120px] gap-4">
          ...
          <div className="w-[90%] mt-4 text-slate-200 text-base font-light">
            ...
            <div className="ml-2 flex gap-4 flex-col">
              <p>
                1. Sama Penting: Keduanya memiliki tingkat penting yang sama
                bagi Anda.
              </p>
              <p>
              ...
              <p>
                5. Sedang: Ini berarti pengaruh keduanya adalah sedang bagi
                Anda.
              </p>
              <p>
                6. Lebih Mendekati Penting: Di sini, Anda merasa bahwa salah
                satu sedikit lebih penting daripada yang lain.
              </p>
              <p>
                7. Jauh Lebih Penting: Pada tahap ini, Anda memandang bahwa
                salah satu jauh lebih penting daripada yang lain.
              </p>
              <p>
                8. Jauh Lebih dari Penting: Ini menunjukkan bahwa salah satu
                jauh lebih penting daripada yang lain, dengan perbedaan yang
                sangat besar.
              </p>
              <p>
                9. Mutlak Lebih Penting: Terakhir, Anda memandang bahwa salah
                satu mutlak lebih penting daripada yang lain
              </p>
            </div>
